...
{
    public class ForeignOfficeUserRegistrationController : Controller
    {
        ...
        public ForeignOfficeUserRegistrationController(IConfiguration configuration)
        {
        ...
        {
            List<ForeignOfficeUserRegistrationModel> office_user = new List<ForeignOfficeUserRegistrationModel>();
            _connection.Open();
            ...
            {
                var foreign_office_user = new ForeignOfficeUserRegistrationModel()
                {
                ...
                office_user.Add(foreign_office_user);
            }
        ...
        public IActionResult AddNewRecord(string office_user_name, string office_user_address, string office_user_national_id_number, string office_user_phone_number, string office_user_gmail, string office_user_type, string office_user_password_hash, string office_user_latitude, string office_user_longitude)
        {
            try
            {
                ...
                return RedirectToAction("Index", "ForeignOfficeUserRegistration");
