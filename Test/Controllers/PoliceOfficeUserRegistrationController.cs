...
{
    public class PoliceOfficeUserRegistrationController : Controller
    {
        ...
        public PoliceOfficeUserRegistrationController(IConfiguration configuration)
        {
        ...
        {
            List<PoliceOfficeUserRegistrationModel> office_user = new List<PoliceOfficeUserRegistrationModel>();
            _connection.Open();
            ...
            {
                var police_office_user = new PoliceOfficeUserRegistrationModel()
                {
                ...
                office_user.Add(police_office_user);
            }
        ...
        public IActionResult AddNewRecord(string office_user_name, string office_user_address, string office_user_national_id_number, string office_user_phone_number, string office_user_gmail, string office_user_type, string office_user_password_hash, string office_user_latitude, string office_user_longitude)
        {
            try
            {
                ...
                return RedirectToAction("Index", "PoliceOfficeUserRegistration");
